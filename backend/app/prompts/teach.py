...
def build_teach_system_prompt(
    ...
    direction_hint = f"\n\n【学习方向】本节课学习的大方向是「{learning_direction}」，请围绕这个方向来理解老师教的内容，不要偏离这个方向讨论无关话题。" if learning_direction else ""
...
7. 语气保持热情、好学、略带高中生的稚气，使用"老师"或"你"称呼对方，用"我"称呼自己。{empty_hint}{direction_hint}
